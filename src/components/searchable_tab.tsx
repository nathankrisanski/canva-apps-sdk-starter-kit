...
interface DetailedData {
  ...
  marketData?: {
    ...
    labels: { property: string; label: string; format: string }[];
  };
}
...
export const SearchableTab: React.FC<SearchableTabProps> = ({
  ...
  const getDefaultMetrics = useCallback(
    (labels: { property: string; label: string; format: string }[]) => {
      ...
      console.log(
        ...
        labels.map((l) => ({ property: l.property, label: l.label })),
      );
  ...
  const getSearchedMetrics = useCallback(
    (labels: { property: string; label: string; format: string }[]) => {
  ...
  const searchAPI = useCallback(
    async (query: string) => {
      ...
      try {
        ...
        const results: SearchResult[] = resultArray.map(
      ...
      try {
        ...
        if (endpoint === "market-data" && itemData.output) {
          ...
          if (Array.isArray(itemData.photos) && itemData.photos.length > 0) {
            detailedInfo.images = itemData.photos.map(
              ...
              {detailedData.marketData && (
                ...
                >
                  <Rows spacing="2u">
                    ...
                    {getDefaultMetrics(detailedData.marketData.labels).map(
                      (labelInfo) => {
                        const houseValue =
                          detailedData.marketData?.house[labelInfo.property];
                        const unitValue =
                          detailedData.marketData?.unit[labelInfo.property];
                    ...
                    <Rows spacing="2u">
                      ...
                      {getSearchedMetrics(detailedData.marketData.labels).map(
                        (labelInfo) => {
                          const houseValue =
                            detailedData.marketData?.house[labelInfo.property];
                          const unitValue =
              ...
              {endpoint === "listings" ? (
                <Rows spacing="2u">
                  ...
                  {detailedData.textFields &&
                    detailedData.textFields.length > 0 && (
                      <Rows spacing="2u">
                        {/* Bedrooms, Bathrooms, Car Spaces Row */}
                        {(() => {
                          const bedrooms = detailedData.textFields.find((f) =>
                            f.field.toLowerCase().includes("bedroom"),
                          );
                          const bathrooms = detailedData.textFields.find((f) =>
                            f.field.toLowerCase().includes("bathroom"),
                          );
                          const carSpaces = detailedData.textFields.find((f) =>
                            f.field.toLowerCase().includes("garage"),
                          );
                              ...
                              <Columns spacing="2u">
                                {bedrooms && (
                                  <Column>
                                    ...
                                    <TypographyCard
                                      onClick={() =>
                                        handleTextFieldClick(bedrooms.value)
                                      }
                                ...
                                {bathrooms && (
                                  <Column>
                                    ...
                                    <TypographyCard
                                      onClick={() =>
                                        handleTextFieldClick(bathrooms.value)
                                      }
                                ...
                                {carSpaces && (
                                  <Column>
                                    ...
                                    <TypographyCard
                                      onClick={() =>
                                        handleTextFieldClick(carSpaces.value)
                                      }
                        ...
                        {/* Address */}
                        {(() => {
                          const address = detailedData.textFields.find((f) =>
                            f.field.toLowerCase().includes("address"),
                          );
                          if (address) {
                            return (
                              <Rows spacing="0.5u">
                                ...
                                <TypographyCard
                                  onClick={() =>
                                    handleTextFieldClick(address.value)
                                  }
                        ...
                        {(() => {
                          const suburb = detailedData.textFields.find((f) =>
                            f.field.toLowerCase().includes("suburb"),
                          );
                          const state = detailedData.textFields.find((f) =>
                            f.field.toLowerCase().includes("state"),
                          );
                          const postcode = detailedData.textFields.find((f) =>
                            f.field.toLowerCase().includes("postcode"),
                          );
                              ...
                              <Columns spacing="2u">
                                {suburb && (
                                  <Column>
                                    ...
                                    <TypographyCard
                                      onClick={() =>
                                        handleTextFieldClick(suburb.value)
                                      }
                                ...
                                {state && (
                                  <Column>
                                    ...
                                    <TypographyCard
                                      onClick={() =>
                                        handleTextFieldClick(state.value)
                                      }
                                ...
                                {postcode && (
                                  <Column>
                                    ...
                                    <TypographyCard
                                      onClick={() =>
                                        handleTextFieldClick(postcode.value)
                                      }
                        ...
                        {detailedData.textFields
                          ...
                          .map((field, index) => (
                            ...
                            >
                              ...
                              <TypographyCard
                                onClick={() =>
                                  handleTextFieldClick(field.value)
                                }
